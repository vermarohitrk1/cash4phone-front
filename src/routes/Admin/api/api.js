...
export const customer_phones           = process.env.REACT_APP_API_URL+"admin/sales/customer_phones";
export const customers           = process.env.REACT_APP_API_URL+"admin/sales/customers";
